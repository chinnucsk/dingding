...
process_url(P, Prefix, Args, URL) ->
    ...
    case byte_size(URL) > 100 of
        true -> dd_connection:reply(self(), Args, tinyurl(URL));
        _ -> ok
    end,
...
do_url_funs(P, Args, URL, Title) ->
    ...
    Funs = [ fun dd_imdb:info_if_imdb_url/1,
             fun dd_command_handler:reply_if_single_tweet/1], 
